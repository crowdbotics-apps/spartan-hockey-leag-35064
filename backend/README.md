...
## Project Structure
    ...
    ├── spartan_hockey_leag_35064  # Django project configurations
...
1. Clone this repo and `cd spartan_hockey_leag_35064`
...
2. Clone this repo and `cd spartan_hockey_leag_35064`
